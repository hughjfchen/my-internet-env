...
#${SCRIPT_ABS_PATH}/../../../../DevOps/kamatera-hk/test/test/unprepare.sh
...
#${SCRIPT_ABS_PATH}/../../../../DevOps/kamatera-hk/test/build/unfinishing.sh
...
# I don't think we need this either
#${SCRIPT_ABS_PATH}/../../../../DevOps/kamatera-hk/test/build/unprepare.sh
#${SCRIPT_ABS_PATH}/../../../../DevOps/kamatera-hk/test/unprepare.sh

done_banner "wg" "Cont. UnBuild, UnDeploy and UnTest"
